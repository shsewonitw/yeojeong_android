...
public class Withme_view {
    ...
    public Withme_view(int article_id, String member_id, String country, String city, Date start_date, Date end_date, int category_gender, int category_age, int category_style, Date write_time, int travel_id, String name) {
